...
// ボックスをここにドラッグ
function box_here(){
  echo '<style type="text/css">.metabox-holder .postbox-container .empty-container {display:none;}</style>';
}
add_action('admin_head', 'box_here');
...
================================================*/
function add_styles() {
  wp_enqueue_style('style', get_template_directory_uri(). '/dist/css/style.css', false, 'all');
}
